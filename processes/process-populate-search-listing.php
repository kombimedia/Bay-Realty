...
// populate search listings
    $search_output = $search_output . "
        ...
        <tr>
        <td> <a class='view-listing' href='product.php?listing_id=$listing_id'><img width='250' height='200px'  src='images/uploads/$row[featured_image]'></td>
        <td><a><h4 >$row[title]</h4><p style='color: grey'>$row[address]</p><hr>
        <p>$string ...</p>
        <h4>$price</h4>
